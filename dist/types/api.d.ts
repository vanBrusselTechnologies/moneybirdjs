...
export type APILedgerAccountType = "non_current_assets" | "current_assets" | "equity" | "provisions" | "non_current_liabilities" | "current_liabilities" | "revenue" | "direct_costs" | "expenses" | "other_income_expenses";
export type APILedgerAccountAllowedDocumentTypes = "purchase_invoice" | "sales_invoice" | "financial_mutation" | "general_journal_document" | "payment";
...
export type APIUserPermissions = 'sales_invoices' | 'documents' | 'estimates' | 'bank' | 'settings' | 'ownership' | 'time_entries';
