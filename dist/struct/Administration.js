...
const DocumentStyle_1 = require("./DocumentStyle");
const ExternalSalesInvoice_1 = require("./ExternalSalesInvoice");
const GeneralDocument_1 = require("./GeneralDocument");
...
const LedgerAccount_1 = require("./LedgerAccount");
...
class Administration {
    ...
    async listContactsByIds(ids) {
        ...
        return data.map((entry) => new Contact_1.Contact(this, entry));
    }
    ...
    async getContact(contactId) {
        ...
        return new Contact_1.Contact(this, data);
    }
    ...
    async getCustomFields() {
        ...
        return data.map((entry) => new CustomField_1.CustomField(this, entry));
    }
    async getDocumentStyles() {
        const { data } = await this.client.rest.getDocumentStyles(this);
        return data.map((entry) => new DocumentStyle_1.DocumentStyle(this, entry));
    }
    async listGeneralDocumentsByIds(ids) {
        const { data } = await this.client.rest.listDocumentsByIds(this, 'generalDocument', ids);
        return data.map((entry) => new GeneralDocument_1.GeneralDocument(this, entry));
    }
    ...
    async getGeneralDocument(generalDocumentId) {
        ...
        return new GeneralDocument_1.GeneralDocument(this, data);
    }
    ...
    async listJournalDocumentsByIds(ids) {
        ...
        return data.map((entry) => new JournalDocument_1.JournalDocument(this, entry));
    }
    ...
    async getJournalDocument(journalDocumentId) {
        ...
        return new JournalDocument_1.JournalDocument(this, data);
    }
    ...
    async listPurchaseInvoicesByIds(ids) {
        ...
        return data.map((entry) => new PurchaseInvoice_1.PurchaseInvoice(this, entry));
    }
    ...
    async getPurchaseInvoice(purchaseInvoiceId) {
        ...
        return new PurchaseInvoice_1.PurchaseInvoice(this, data);
    }
    ...
    async listReceiptsByIds(ids) {
        ...
        return data.map((entry) => new Receipt_1.Receipt(this, entry));
    }
    ...
    async getReceipt(receiptId) {
        ...
        return new Receipt_1.Receipt(this, data);
    }
    ...
    async listTypelessDocumentsByIds(ids) {
        ...
        return data.map((entry) => new TypelessDocument_1.TypelessDocument(this, entry));
    }
    ...
    async getTypelessDocument(typelessDocumentId) {
        ...
        return new TypelessDocument_1.TypelessDocument(this, data);
    }
    ...
    async getFinancialMutations(filter) {
        ...
        return data.map((entry) => new FinancialMutation_1.FinancialMutation(this, entry));
    }
    ...
    async getFinancialMutation(financialMutationId) {
        ...
        return new FinancialMutation_1.FinancialMutation(this, data);
    }
    ...
    async getLedgerAccounts() {
        ...
        return data.map((entry) => new LedgerAccount_1.LedgerAccount(this, entry));
    }
    async getLedgerAccount(ledgerAccountId) {
        const { data } = await this.client.rest.getLedgerAccount(this, ledgerAccountId);
        return new LedgerAccount_1.LedgerAccount(this, data);
    }
    ...
    async getTaxRates(filter = { tax_rate_type: 'all' }) {
        ...
        return data.map((entry) => new TaxRate_1.TaxRate(this, entry));
    }
}
