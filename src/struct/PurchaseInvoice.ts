...
export class PurchaseInvoice {
    ...
    constructor(public administration: Administration, data: APIPurchaseInvoice) {
        this.id = data.id;
    ...
    async update(options: UpdatePurchaseInvoiceOptions) {
        const {data} = await this.administration.client.rest.updateDocument<APIPurchaseInvoice>(this, options)
        this.setData(data)
        return this;
    }

    async delete(refresh_journal_entries?: boolean) {
        await this.administration.deletePurchaseInvoice(this.id, refresh_journal_entries)
    }
    ...
    private setData(data: APIPurchaseInvoice) {
        this.id = data.id;
        this.administration_id = data.administration_id;
        this.contact_id = data.contact_id
        this.reference = data.reference;
